...
#include "BT/BTService_ChecakPattern.h"

#include "BehaviorTree/BlackboardComponent.h"

UBTService_ChecakPattern::UBTService_ChecakPattern()
{
	NodeName = TEXT("Check Attack Chance");
	Interval = 1.0f;
}

void  UBTService_ChecakPattern::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
